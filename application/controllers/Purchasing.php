<?php
	class Purchasing extends CI_Controller {
		public function index() {
			...
			$crud->display_as('po_date','Tanggal PO')->display_as('po_ref','Nomor PO')->display_as('customer_id','Customer')->display_as('products','Barang');
			...
			$output = $crud->render();
			$output->sidebar = 'purchasing';
			$output->page_title = 'Pembelian';
		...
		public function surat_jalan_column_callback($value,$row) {
			return '<a href="'.base_url('sales/suratjalan/index/add/').'">test</a>';
		}
