...
<div class="form-horizontal" style="margin-top:20px;">
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<input type="text" class="form-control" name="net_total" id="net_total" style="width:185px;" readonly="readonly">
		</div>
	</div>
</div>
<script>
	...
	var gColumns = [
		...
		{ name: 'unit_price', display: 'Harga Satuan', type: 'text', ctrlAttr: { maxlength: 7,'class':'unit-price' }, ctrlCss: { width: '100px' } },
